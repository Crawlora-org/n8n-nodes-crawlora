	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			description:
				'Your Crawlora API key. Find it at [https://crawlora.net/app/api-keys](https://crawlora.net/app/api-keys?utm_source=github&utm_medium=referral&utm_campaign=n8n-nodes-crawlora) (new accounts include a free monthly credit allowance).',
		},
	];
